...
public class Bootstrap {
    @Getter
    private static final int protocolVersion = 2; // update ONLY on breaking protocol changes
    ...
    public static void main(String[] args) {
        ...
        homeDir = new File(new File("").getAbsolutePath());
